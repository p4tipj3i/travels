<?php
    ...
    $sql1 = "SELECT * FROM `all_travels` where `tid`='1'";
  ...
  <div id="wrapper_ilinerary">
    ...
    <div="content">
      <form style="background-color:rgba(250, 250, 250,60);" method="post" action="data/usertravel_insert.php">
        ...
        <div class="form-group">
          <input class="form-control" placeholder="行程編號" type="text" value="行程編號：1" disabled="disabled">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <!--<input id="date" type="date">background-position: center center; 日曆選擇器-->
          <input class="form-control" placeholder="回程日期"  type="text" value="回程日期：<?php echo $row1['backdate']; ?>" disabled="disabled">
        </div>
        <div class="form-group">
        ...
        <input class="form-control" placeholder="行程編號" name="tid" type="hidden" value="1">
