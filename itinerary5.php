<?php
    ...
    //$tid=$_POST['tid'];
    $sql1 = "SELECT * FROM `all_travels` where `tid`='5'";
      ...
      <div id="wrapper_ilinerary">
        ...
        <div="content">
          <form style="background-color:rgba(250, 250, 250,60);"   method="post" action="data/usertravel_insert.php">
            ...
            <div class="form-group">
            <input class="form-control" placeholder="行程編號" type="text" value="行程編號：5" disabled="disabled">                         
            </div>
            <div class="form-group">
            ...
            <input class="form-control" placeholder="行程編號" name="tid" type="hidden" value="5">
